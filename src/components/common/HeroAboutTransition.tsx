 ...
 * and a subtle parallax drift for a cinematic agri feel.
 */
    ...
    >
      ...
      >
        <defs>
          ...
          {/* warm golden sunlight tint over the top of the front hill */}
        ...
        {/* Cream base merging into About background */}
        <path
